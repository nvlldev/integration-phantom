            ...
            if cost_entities:
                ...
                if upstream_energy_entity:
                    ...
                    if upstream_meter_entity:
                        ...
                        # Create cost remainder sensor if we have both upstream cost and group total cost
                        # Find upstream cost entity
                        ...
                        if upstream_cost_entity and group_total_cost_entity:
